...
const propRows: PropRow[] = [
  ...
  {
    defaultValue: 'glow, shimmer',
    description: 'The lit rim glow, the press ripple, the iridescent shimmer and the drifting sparkle. Glow and shimmer are on; ripple and sparkle are not. Each is drawn by the WebGL pass, so all four are inert while webgl is off.',
    name: 'glow / ripple / shimmer / sparkle',
    type: 'boolean',
  },
  {
    defaultValue: '0.7',
    description: 'How much of the bend the material can take without folding to spend, 0 to 1. Only visible while lens is on.',
    name: 'refraction',
    type: 'number',
  },
  {
